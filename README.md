...
| locations | false    | `'["*"]'` | `'["NA.*"]'`            | Locations where the requests will sent from. Example: ["NA.US.*", "EU.FR.PR"]. Locations: [Ddosify Docs](https://docs.ddosify.com/cloud/api/latency-testing-api#example-usages-of-locations-object)  |
